...
class SendsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create send" do
    assert_difference('Send.count') do
      post sends_url, params: { send: { email: @send.email, message: @send.message, sender: @send.sender, sendtime: @send.sendtime, subject: @send.subject } }
    end
  ...
  test "should update send" do
    patch send_url(@send), params: { send: { email: @send.email, message: @send.message, sender: @send.sender, sendtime: @send.sendtime, subject: @send.subject } }
